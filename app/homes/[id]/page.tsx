...
export default async function Home({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <PageWrapper className="flex flex-col justify-center items-center *:w-full">
            ...
            <div className="centered-default lg:pt-10 pb-60 max-sm:pb-16">

                <hr className="my-8 border-c-shape-1" />


                <div className="grid lg:grid-cols-3 max-lg:*:*:text-right max-lg:[&_span]:text-left max-lg:gap-5 body-2 *:w-full *:*:grid *:*:grid-cols-2 *:*:gap-x-8 *:*:wrap-break-word">
                    <ul>
                        <li>
                ...
                <div className="mt-20 flex max-lg:flex-col justify-between gap-10 *:*:first:mb-5">
                    ...
                    <section>
                        ...
                        <AgentContact agent={home.agent} className="p-10 lg:pr-24 max-sm:p-5" outline />
                    </section>
                </div>
            </div>
        </PageWrapper>
